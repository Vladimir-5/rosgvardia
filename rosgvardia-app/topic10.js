// Данные файлов для темы 10
const topic10Files = [
    {
        icon: "📊",
        name: "Презентация РМГ10.pptx",
        size: "3.3 MB",
        url: "https://drive.google.com/uc?export=download&id=1ZpN5yB_PYwUJ7Pr8Wnwz0Bkl4Pdv9JXX"
    },
    {
        icon: "📝",
        name: "Технологическая карта урока.docx",
        size: "145 KB",
        url: "https://drive.google.com/uc?export=download&id=1NeHZAPQT1wqrhzTmNwovU5owwlBYJGwI"
    },
    {
        icon: "📝",
        name: "План проведения занятия.docx",
        size: "2.1 MB",
        url: "https://drive.google.com/uc?export=download&id=1XP-siaVvmCggkrVUxdJL80q0seB1AosI"
    }
];

// Функция для рендеринга файлов в модальном окне
function renderTopic10Files() {
    const container = document.getElementById('modalBody');
    if (!container) return;
    
    container.innerHTML = `
        <div class="topic-files-list">
            ${topic10Files.map(file => `
