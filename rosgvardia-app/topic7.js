// Данные файлов для темы 7
const topic7Files = [
    {
        icon: "📝",
        name: "План проведения занятия.docx",
        size: "2.7 MB",
        url: "https://drive.google.com/uc?export=download&id=1hZe-LMJtUiZs_x4DHdhOTiDctEOf0oAU"
    },
    {
        icon: "📊",
        name: "Презентация РМГ7.pptx",
        size: "167 KB",
        url: "https://drive.google.com/uc?export=download&id=1cDkE2B7PY0c4aEOJ7fX9B6gaj61Pihef"
    },
    {
        icon: "🎬",
        name: "Видеоролик № 2 о профессиях.mp4",
        size: "35 MB",
        url: "https://drive.google.com/uc?export=download&id=1vCztE4SNGVYD5UoaDSe1YPwrAhgq5d7c"
    },
    {
        icon: "🎬",
        name: "Видеоролик № 1 об отрасли.mp4",
        size: "145 KB",
        url: "https://drive.google.com/uc?export=download&id=1LnASQDX4mvIntD7YHX53w02LMjW0ttel"
    }
];

function renderTopic7Files() {
    const container = document.getElementById('modalBody');
    if (!container) return;
    
    container.innerHTML = `
        <div class="topic-files-list">
            ${topic7Files.map(file => `
