// Данные файлов для темы 8
const topic8Files = [
    {
        icon: "🎬",
        name: "Фильм Граф Комаровский.mp4",
        size: "3.0 MB",
        url: "https://drive.google.com/uc?export=download&id=1s8B2tTKatIgEQuO-4u_9LMmXbEref1Hy"
    },
    {
        icon: "📝",
        name: "План проведения занятия.docx",
        size: "198 KB",
        url: "https://drive.google.com/uc?export=download&id=1-Ry6iRdg2VSiZh8nlCo2A7Rps4Q-7xlD"
    },
    {
        icon: "📝",
        name: "Раздаточный материал.docx",
        size: "450 KB",
        url: "https://drive.google.com/uc?export=download&id=1qrdr3b8lrA0HP1JSgGz-zDUAy0j_vkMj"
    },
    {
        icon: "📊",
        name: "Презентация РМГ8.pptx",
        size: "1.2 MB",
        url: "https://drive.google.com/uc?export=download&id=1FMPZ9Ps_dnpsxSDldQ449Ay-WYb0_9_V"
    }
];

function renderTopic8Files() {
    const container = document.getElementById('modalBody');
    if (!container) return;
    
    container.innerHTML = `
        <div class="topic-files-list">
            ${topic8Files.map(file => `
